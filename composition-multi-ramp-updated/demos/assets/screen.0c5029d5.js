import{eu as f,et as u,ev as C,ew as c,ex as b,ey as p,eW as g,eI as w,ez as i,eA as r,eB as m,eK as x}from"./multi-ramp.78fd17d4.js";var v=`<?xml version="1.0" encoding="UTF-8"?>
...
`;const L=u({name:"MetadataScreenV",props:{panel:{type:Object},payload:{type:Object,required:!0}},data(){return{state:{status:"loading",response:null},cache:{}}},mounted(){this.payload.type==="xml"?this.loadFromURL(this.payload.url,[]).then(e=>{this.state.status="success",e!==null&&this.$el.childNodes[1].appendChild(e)}):this.payload.type==="html"&&this.requestContent(this.payload.url).then(e=>{this.state.status="success",this.state.response=e.response})},methods:{loadFromURL(e,n){let s=this.$iApi.language==="en"?v:S;return s=s.replace(/\{\{([\w.]+)\}\}/g,(t,a)=>this.$t(a)),this.cache[e]?Promise.resolve(this.applyXSLT(this.cache[e],s,n)):this.requestContent(e).then(t=>(this.cache[e]=t.response,this.applyXSLT(this.cache[e],s,n)))},applyXSLT(e,n,s){let t=null;if(window.XSLTProcessor){const a=new window.XSLTProcessor,o=new DOMParser,l=o.parseFromString(e,"text/xml"),d=o.parseFromString(n,"text/xml");a.importStylesheet(d),s&&s.forEach(h=>a.setParameter("",h.key,h.value||"")),t=a.transformToFragment(l,document)}else if(window.hasOwnProperty("ActiveXObject")){const a=new window.ActiveXObject("Msxml2.XSLTemplate"),o=new window.ActiveXObject("Msxml2.DOMDocument"),l=new window.ActiveXObject("Msxml2.FreeThreadedDOMDocument");o.loadXML(e),l.loadXML(n),a.stylesheet=l;const d=a.createProcessor();d.input=o,d.transform(),t=document.createRange().createContextualFragment(d.output)}return t},requestContent(e){return new Promise((n,s)=>{const t=new XMLHttpRequest;t.open("GET",e,!0),t.responseType="text",t.onload=()=>{t.status===200?n({status:"success",response:t.response}):n({status:"error",response:"Could not load results from remote service."})},t.onerror=()=>{n({status:"error",response:"Could not load results from remote service."})},t.send()})}}}),O={class:"flex justify-center"},$={key:0,class:"flex flex-col justify-center text-center"},y=g(" Loading... "),_=i("div",{class:"flex flex-col justify-center"},null,-1),P=["innerHTML"],T=i("div",{class:"flex flex-col justify-center text-center"},[i("img",{src:"https://i.imgur.com/fA5EqV6.png"}),i("span",{class:"text-xl mt-20"},[r(" TODO: Localize this "),g(" There was an error retrieving this resource. Please try again.")])],-1);function M(e,n,s,t,a,o){const l=C("panel-screen");return c(),b(l,{panel:e.panel},{header:p(()=>[g(w(e.$t("metadata.title"))+": "+w(e.payload.layerName),1)]),content:p(()=>[i("div",O,[r(" Loading Screen "),e.state.status=="loading"?(c(),m("div",$,[r(" TODO: Localize this "),y])):e.payload.type==="xml"&&e.state.status=="success"?(c(),m(x,{key:1},[r(" Found Screen, XML "),_],2112)):e.payload.type==="html"&&e.state.status=="success"?(c(),m(x,{key:2},[r(" Found Screen, HTML "),i("div",{innerHTML:e.state.response,class:"flex flex-col justify-center max-w-full"},null,8,P)],2112)):(c(),m(x,{key:3},[r(" Error Screen "),T],2112))])]),_:1},8,["panel"])}var X=f(L,[["render",M],["__file","/home/runner/work/ramp4-pcar4/ramp4-pcar4/src/fixtures/metadata/screen.vue"]]);export{X as default};
