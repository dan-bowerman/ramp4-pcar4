import{eu as C,et as b,eF as g,ew as d,eG as v,eH as p,eX as S,eJ as w,eP as f,eA as i,eI as m,ex as x,eL as h}from"./main.1c7a89ed.js";var $=`<?xml version="1.0" encoding="UTF-8"?>
...
`;const y=b({name:"MetadataScreenV",props:{panel:{type:Object},payload:{type:Object,required:!0}},data(){return{state:{status:"loading",response:null},cache:{}}},mounted(){this.payload.type==="xml"?this.loadFromURL(this.payload.url,[]).then(e=>{this.state.status="success",e!==null&&this.$el.childNodes[1].appendChild(e)}):this.payload.type==="html"&&this.requestContent(this.payload.url).then(e=>{this.state.status="success",this.state.response=e.response})},methods:{loadFromURL(e,n){let s=this.$iApi.language==="en"?$:L;return s=s.replace(/\{\{([\w.]+)\}\}/g,(t,a)=>this.$t(a)),this.cache[e]?Promise.resolve(this.applyXSLT(this.cache[e],s,n)):this.requestContent(e).then(t=>(this.cache[e]=t.response,this.applyXSLT(this.cache[e],s,n)))},applyXSLT(e,n,s){let t=null;if(window.XSLTProcessor){const a=new window.XSLTProcessor,l=new DOMParser,r=l.parseFromString(e,"text/xml"),o=l.parseFromString(n,"text/xml");a.importStylesheet(o),s&&s.forEach(c=>a.setParameter("",c.key,c.value||"")),t=a.transformToFragment(r,document)}else if(window.hasOwnProperty("ActiveXObject")){const a=new window.ActiveXObject("Msxml2.XSLTemplate"),l=new window.ActiveXObject("Msxml2.DOMDocument"),r=new window.ActiveXObject("Msxml2.FreeThreadedDOMDocument");l.loadXML(e),r.loadXML(n),a.stylesheet=r;const o=a.createProcessor();o.input=l,o.transform(),t=document.createRange().createContextualFragment(o.output)}return t},requestContent(e){return new Promise((n,s)=>{const t=new XMLHttpRequest;t.open("GET",e,!0),t.responseType="text",t.onload=()=>{t.status===200?n({status:"success",response:t.response}):n({status:"error",response:"Could not load results from remote service."})},t.onerror=()=>{n({status:"error",response:"Could not load results from remote service."})},t.send()})}}}),O={class:"flex justify-center"},P={key:0,class:"flex flex-col justify-center text-center"},_=i("div",{class:"flex flex-col justify-center"},null,-1),T=["innerHTML"],M=i("div",{class:"flex flex-col justify-center text-center"},[i("img",{src:"https://i.imgur.com/fA5EqV6.png"}),i("span",{class:"text-xl mt-20"},"There was an error retrieving this resource. Please try again.")],-1);function N(e,n,s,t,a,l){const r=g("minimize"),o=g("close"),c=g("panel-screen");return d(),v(c,null,{header:p(()=>[S(w(e.$t("metadata.title"))+": "+w(e.payload.layerName),1)]),controls:p(()=>[f(r,{onClick:n[0]||(n[0]=u=>e.panel.minimize())}),f(o,{onClick:n[1]||(n[1]=u=>e.panel.close())})]),content:p(()=>[i("div",O,[m(" Loading Screen "),e.state.status=="loading"?(d(),x("div",P," Loading... ")):e.payload.type==="xml"&&e.state.status=="success"?(d(),x(h,{key:1},[m(" Found Screen, XML "),_],2112)):e.payload.type==="html"&&e.state.status=="success"?(d(),x(h,{key:2},[m(" Found Screen, HTML "),i("div",{innerHTML:e.state.response,class:"flex flex-col justify-center max-w-full"},null,8,T)],2112)):(d(),x(h,{key:3},[m(" Error Screen "),M],2112))])]),_:1})}var k=C(y,[["render",N],["__file","/home/runner/work/ramp4-pcar4/ramp4-pcar4/src/fixtures/metadata/screen.vue"]]);export{k as default};
